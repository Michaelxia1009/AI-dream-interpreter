  ...
  if (!circle) {
    return (
      <main className="aurora-bg grid min-h-dvh place-items-center px-6 text-center">
        <div>
          <h1 className="font-serif text-4xl">Circle not found</h1>
          <Link href="/circles" className="mt-4 inline-flex rounded-full border border-border px-5 py-3 text-sm text-muted-foreground">
            Back to circles
          </Link>
        </div>
      </main>
    ...
    <main className="aurora-bg min-h-dvh px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-6xl">
        <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Circle</p>
            <h1 className="mt-2 font-serif text-5xl leading-tight tracking-tight">{circle.name}</h1>
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
              {circle.description || 'A private place for shared dream notes.'}
            </p>
          </div>
          <button
            type="button"
            onClick={copyInvite}
            className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-card/40 px-4 py-3 text-sm text-foreground transition hover:border-ring/60"
          >
        ...
        <section className="surface-glass mb-5 rounded-2xl p-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
            ...
            <button
              ...
              className="aurora-cta inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-semibold disabled:opacity-50"
            >
        ...
        {circle.dreams.length === 0 ? (
          <section className="surface-glass rounded-2xl p-8 text-center">
            ...
            <h2 className="mt-4 font-serif text-3xl tracking-tight">No shared dreams yet</h2>
